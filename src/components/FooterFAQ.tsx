...
export const ComparisonChoice: React.FC<{
  ...
  return (
    <SectionWrapper id="choice_section">
      <h2 className="text-3xl md:text-4xl text-center mb-16">{title}</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-16">
        <div className="bg-white p-8 md:p-12 rounded-card shadow-soft border-t-8 border-gray-300">
        ...
        <div className="bg-white p-8 md:p-12 rounded-card shadow-xl border-t-8 border-olive transform md:scale-105">
  ...
  return (
    <SectionWrapper id="faq">
      ...
      <div className="max-w-3xl mx-auto space-y-4">
        {items.map((item, i) => (
          <div key={i} className="bg-white rounded-xl shadow-soft overflow-hidden border border-card-border">
            <button
